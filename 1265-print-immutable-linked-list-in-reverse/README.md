<h2><a href="https://leetcode.com/problems/print-immutable-linked-list-in-reverse/?envType=problem-list-v2&envId=linked-list">1265. Print Immutable Linked List in Reverse</a></h2><h3>Medium</h3><hr><p>You are given an immutable linked list, print out all values of each node in reverse with the help of the following&nbsp;interface:</p>
