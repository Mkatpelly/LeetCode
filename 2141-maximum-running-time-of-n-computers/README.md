<h2><a href="https://leetcode.com/problems/maximum-running-time-of-n-computers/?envType=company&envId=facebook&favoriteSlug=facebook-thirty-days">2141. Maximum Running Time of N Computers</a></h2><h3>Hard</h3><hr><p>You have <code>n</code> computers. You are given the integer <code>n</code> and a <strong>0-indexed</strong> integer array <code>batteries</code> where the <code>i<sup>th</sup></code> battery can <strong>run</strong> a computer for <code>batteries[i]</code> minutes. You are interested in running <strong>all</strong> <code>n</code> computers <strong>simultaneously</strong> using the given batteries.</p>
